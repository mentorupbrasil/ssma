...
export default async function QuotePrintPage({
  ...
  return (
    <html lang="pt-BR">
      <head>
        <title>{quote.quoteNumber} — {quote.companyName}</title>
        <style>{`
          body { font-family: system-ui, sans-serif; color: #1e293b; max-width: 800px; margin: 0 auto; padding: 2rem; }
          h1 { color: #0F3D4A; font-size: 1.5rem; margin-bottom: 0.25rem; }
          .header { border-bottom: 2px solid #16A085; padding-bottom: 1rem; margin-bottom: 1.5rem; }
          .meta { display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem; font-size: 0.875rem; }
          table { width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.875rem; }
          th, td { border: 1px solid #e2e8f0; padding: 0.5rem 0.75rem; text-align: left; }
          th { background: #f8fafc; }
          .total { font-size: 1.125rem; font-weight: 700; color: #16A085; margin-top: 1rem; }
          .footer { margin-top: 2rem; padding-top: 1rem; border-top: 1px solid #e2e8f0; font-size: 0.8rem; color: #64748b; }
