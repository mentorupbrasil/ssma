  ...
  return (
    <div>
      <PageHeader
        ...
        description={patient.company?.tradeName ?? patient.company?.legalName ?? "Sem empresa"}
      />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <p>
              <strong>Função:</strong> {patient.jobTitle ?? "—"}
            </p>
            <p>
              <strong>Setor:</strong> {patient.department ?? "—"}
            </p>
            <p>
