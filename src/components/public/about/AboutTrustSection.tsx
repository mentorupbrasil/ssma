          ...
          <div className="about-ed-trust-panel">
            <div className="about-ed-trust-copy">
              ...
              <TimelineContent animationNum={1} timelineRef={sectionRef}>
                <h2 className="about-ed-trust-title">Estrutura, confiança e conformidade</h2>
              </TimelineContent>
              <TimelineContent animationNum={2} timelineRef={sectionRef}>
                <p className="about-ed-trust-desc">
                  Dados ocupacionais exigem cuidado, organização e controle. Por isso, a Unimetra
                  trabalha com fluxos pensados para apoiar empresas na gestão de documentos, exames
                  e informações sensíveis — com portal empresarial como apoio ao atendimento da
                  clínica.
                </p>
              </TimelineContent>
            </div>
