...
export const DASHBOARD_NAV = [
  ...
  { href: "/dashboard/encaminhamentos", label: "Atendimentos", icon: "FileText", permission: "referrals.manage" as Permission },
  { href: "/dashboard/agenda", label: "Atendimentos agendados", icon: "CalendarDays", permission: "appointments.manage" as Permission },
